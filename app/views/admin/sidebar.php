    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar nav-sidebar-admin" data-nav-type="accordion">
                ...
                <li class="nav-item mb-1">
                    <a href="/admin/competency"
                        class="nav-link nav-link-admin <?= ($currentUrl == '/admin/competency') ? 'active fw-bold' : '' ?>">
                ...
                <li class="nav-item mb-1">
                    <a href="/admin/messages"
                        class="nav-link nav-link-admin <?= ($currentUrl == '/admin/messages') ? 'active fw-bold' : '' ?>">
                        <i class="ph-chat"></i>
                        <span>
                            Messages
                        </span>
                ...
                <li class="nav-item mb-1">
                    <a href="/admin/forgot_requests"
                        class="nav-link nav-link-admin <?= ($currentUrl == '/admin/forgot_requests') ? 'active fw-bold' : '' ?>">
                        <i class="ph-lock"></i>
                        <span>
                ...
                <li class="nav-item mb-1">
                    <a href="/admin/ai"
                        class="nav-link nav-link-admin <?= ($currentUrl == '/admin/ai') ? 'active fw-bold' : '' ?>">
                        <i class="ph-robot"></i>
                        <span>
