<div class="navbar navbar-dark navbar-expand-lg navbar-static border-bottom border-bottom-dark border-opacity-10 my-0 py-0 header-color">
    <div class="container-fluid">
        ...
        <div class="navbar-brand flex-1 flex-lg-0">
            <a href="/supervisor/home" class="d-inline-flex align-items-center">
        ...
        <ul class="nav flex-row justify-content-end order-1 order-lg-2">
            <li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
                <a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
                    ...
                    <span id="adminName1" class="d-none d-lg-inline-block mx-lg-2 text-capitalize" style="color: #00446b">Hi, <?= $_SESSION['supervisor_name']?></span>
                </a>
